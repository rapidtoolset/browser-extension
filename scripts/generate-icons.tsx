...
const DEFAULT_OUTPUT_DIR = path.join(ROOT, 'extensions', 'rapidtoolset', 'public')
...
export async function generateIconSet(options: GenerateIconOptions) {
  ...
  console.log(`Generated ${sizes.length} icon(s) from ${path.relative(ROOT, options.sourcePath)} → ${path.relative(ROOT, options.outputDir)}`)
}
