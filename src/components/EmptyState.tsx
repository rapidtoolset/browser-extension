...
export default function EmptyState({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center gap-2 px-8 py-6 text-center text-muted-foreground",
        className,
      )}
    >
      {icon && (
        <span className="mb-1 text-muted-foreground opacity-25 [&_svg]:size-8 [&_svg]:shrink-0">
          {icon}
        </span>
      )}
